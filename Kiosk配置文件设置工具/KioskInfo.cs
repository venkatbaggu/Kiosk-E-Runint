...
namespace Leinfo.Kiosk.Entity
{
    ...
    public class KioskInfo
    {
        ...
        /// 程序名字
        /// </summary>
        public string ProcessName { get; set; } = "亿润联盟电商平台Kiosk系统";
        /// <summary>
        /// 配置文件
        /// </summary>
        ...
        public bool CompareVer()
        {
            ...
            var currBB = int.Parse(curr[0]) * 10000 + int.Parse(curr[1]) * 100 + int.Parse(curr[2]);
            var lastBB = int.Parse(last[0]) * 10000 + int.Parse(last[1]) * 100 + int.Parse(last[2]);

            return currBB < lastBB;
        }
